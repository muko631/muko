...
*Admins only:*
 ...
 • `/setwelcome <sometext>`*:* set a custom welcome message. Əgər media'a cavab olaraq istifadə etsəniz media'nı xoşgəldin mesajı olaraq qeyd edər.
 • `/setgoodbye <sometext>`*:* Xüsusi bir vida mesajı təyin edin. Əgər media'a cavab olaraq istifadə etsəniz media'nı vida mesajı olaraq qeyd edər.
